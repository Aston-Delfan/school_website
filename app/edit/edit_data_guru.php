    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method='POST' action='update/update_data_guru.php' enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <img src="foto/foto_guru/<?php echo $tampil_siswa['foto']?>" width="100px" class="rounded float-left">
                    </div>
                    </div>
                <!-- /.card-body -->
